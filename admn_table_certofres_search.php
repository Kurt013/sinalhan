...
'<a href="javascript:void(0);" class="btn btn-primary" title="View Details" onclick="openPopup(\'view_rescert_archive.php?id_rescert=' . urlencode($view['id_rescert']) . '\')" style="width: 70px; font-size: 17px; border-radius:30px;">
<i class="fa fa-eye"></i>
</a>';
?>        
            </form>
...
<?php if ($list === 'archived') { ?>
    <div class="form-buttons">
        <form action="./pdf_rescert.php" method="POST" target="_blank">
        ...
        <form action="./excel_rescert.php" method="POST" target="_blank">
