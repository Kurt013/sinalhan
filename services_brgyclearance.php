...
<html>
  <head> 
    <title> Barangay Sinalhan | Barangay Clearance </title>
...
@media (max-width: 768px) {
    ...
    <body>
        ...
        <div class="container-fluid container1"> 
            <div class="row"> 
                <div class="col"> 
                    <div class="header">
                        <h1 class = "docuname"> Barangay Clearance </h1>
    ...
    <div class="qa-card">
        ...
        <div class="answer">
            <h1>To be eligible for a Barangay Clearance, applicants must meet the following criteria:</h1>
    ...
    <div class="qa-card">
        ...
        <div class="answer">
            <h1>To determine the validity of a Barangay Clearance, the following guidelines must be considered:</h1>
            <h2>• The Barangay Clearance is generally valid for <b>six (6) months </b>from the date of issuance.</h2>
    ...
    <div class="qa-card">
        ...
        <div class="answer">
            <h1>To obtain a Barangay Clearance, you need to bring the following documents together with your QR code:</h1>
            <h2>• Certificate of Indigency or Certificate of Residency</h2>
        ...
        <div class="form-body">
            <form method="post" class="form-container">
                                ...
                                <div class="row">
                                    <div class="col">
                                        <div class="form-group">
                                            <label class = "form-label" for="age" class="mtop">Age: </label>
                                            <input class = "form-input" type="number" name="age" max="90" min="1" step="1" class="form-control" 
                                ...
                                <div class="row">
                                    <div class="col">
                                        <div class="form-group">
                                            <label class = "form-label" for="purpose">Purposes:</label>
    ...
    <button class="btn-submit" 
                        type="submit" name="create_brgyclearance">
                  SUBMIT
                  </button>
