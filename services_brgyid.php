...
<html>
  <head> 
  <title> Barangay Sinalhan | Barangay ID </title>
...
.col li {
            margin-bottom: 5px; /* Adjust the gap between list items */
        }
...
@media (max-width: 768px) {
    ...
    <body>
        ...
        <div class="container-fluid container1"> 
            <div class="row"> 
                <div class="col"> 
                    <div class="header">
                        <h1 class="docuname">Barangay ID </h1>
                        <h5> The Barangay ID is an official identification card issued by the barangay. It serves as a proof of residency and identity for individuals living within the barangay jurisdiction. This ID is essential for accessing various local government services, programs, and transactions.
    ...
    <div class="qa-card">
        ...
        <div class="answer">
            <h1>To be eligible for a Barangay ID, applicants must meet the following criteria:</h1>
    ...
    <div class="qa-card">
        ...
        <div class="answer">
            <h1>To determine the validity of a Barangay ID, the following guidelines must be considered:</h1>
            <h2>• The Barangay ID is generally valid for <b>six (6) months </b>from the date of issuance.</h2>
    ...
    <div class="qa-card">
        ...
        <div class="answer">
            <h1>To process a Barangay ID, the following details apply:</h1>
            <h2>• The service is available only from <b>8:00 AM to 5:00 PM</b> on business days.</h2>
            <h2>• The processing time for the Barangay ID is typically <b>a few minutes </b>once the application is submitted.</h2>
    ...
    <div class="qa-card">
        ...
        <div class="answer">
            <h1>To obtain a Barangay ID, you need to bring the following documents together with your QR code:</h1>
      ...
      <div id="popupOverlay" 
        ...
        <div class="form-body">
            <form method="post" class="form-container" enctype="multipart/form-data">
                                ...
                                <h6 class = "icoe">In case of emergency (Contact Person details):</h6>
    ...
    <button class="btn-submit" 
                        type="submit" name="create_brgyid">
                  SUBMIT
                  </button>
