...
$sql = "SELECT * FROM tbl_user WHERE role = :role AND sex = :sex";
...
if (count($result) == 0) {
    ...
    <div style="text-align: center; padding: 20px !important; margin-top: 20px; margin-bottom: 50px">
        ...
        <p class="norec">No female staff have been registered in the system yet.</p>
        <p class="norec2">It looks like there are no female staff members registered in the system yet. Get started by adding new staff to organize your barangay team effectively.</p>
