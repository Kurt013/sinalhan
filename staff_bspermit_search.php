	...
	<table class="table table-hover text-center table-bordered table-responsive" >
		...
		<tbody>
			...
			<?php
				...
				$stmt = $conn->prepare("SELECT * FROM `tbl_bspermit` WHERE `lname` LIKE '%$keyword%' or  `mi` LIKE '%$keyword%' or  `fname` LIKE '%$keyword%' 
                ...
                <tr>
                    <td>    
                        <form action="" method="post">
                            <a class="btn btn-primary" target="blank" style="width: 90px; font-size: 17px; border-radius:30px;" href="bspermit_form.php?id_resident=<?= $view['id_resident'];?>">Generate</a> 
