...
/* Ensure the table expands naturally */
table {
...
<div class="container-fluid">
    ...
    <button class="btns btn-success" name="search_certofindigency">
        Search
    </button>
    <button class="btns btn-info" onclick="window.location.href='admn_certofindigency.php?list=<?= $list ?>'">
        Reload
    </button>
</div>
