...
?>
    ...
    <a>
    <button class="btn btn-danger archive-btn" type="button" style="width: 70px; font-size: 17px;" title="Archive" name="archive_rescert">  <i class="fas fa-archive"></i> </button>
